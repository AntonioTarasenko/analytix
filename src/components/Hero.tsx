        ...
        <motion.div variants={heroVariant}
         ...
         className="container text-center">
            <div className="max-w-screen-md mx-auto">
                ...
                mx-auto px-3 py-1 rounded-full border-t border-blue-500/10
                backdrop-blur-3xl mb-6 md:mb-10">
                ...
                mb-4 md:text-5xl md:mb-5 lg:text-6xl ">
                    ...
                    <span className="relative isolate ms-4">{heroData.decoTitle}
                        <span className='absolute -z-10 top-2 -left-6
                        -right-4 bottom-0.5 bg-foreground/5 rounded-full
                        px-8 ms-3 border-t border-foreground/20
                        shadow-[inset_0px_0px_30px_0px] shadow-foreground/20
                    ...
                    <Dialog>
                        ...
                        xl:max-w-[1000px]'>
                            <AspectRatio ratio={16 / 9}>
                                <ReactPlayer
                                    url='https://youtu.be/FGzo2Dm3Rh8?si=qVyJx0PNGGh_Je9E'
                                    style={{
                                        minWidth: '100%',
                                        maxWidth: '100%',
                                        minHeight: '100%',
